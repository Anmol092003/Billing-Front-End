        ...
        <div className="p-3">
            <div className="mb-3">
                <div className="d-flex align-items-center gap-2">
                    <label htmlFor="customerName" className="col-4" style={{color: '#1a1a1a', fontWeight: '600'}}>Customer name</label>
            ...
            <div className="mb-3">
                <div className="d-flex align-items-center gap-2">
                    <label htmlFor="mobileNumber" className="col-4" style={{color: '#1a1a1a', fontWeight: '600'}}>Mobile number</label>
