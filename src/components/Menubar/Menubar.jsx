                    ...
                    </li>
                    {
                        isAdmin && (
                            <>
                                ...
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/category') ? 'fw-bold text-primary': ''}`} to="/category">Manage Categories</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/users') ? 'fw-bold text-primary': ''}`} to="/users">Manage Users</Link>
                                </li>
                            </>
                        )
                    }
